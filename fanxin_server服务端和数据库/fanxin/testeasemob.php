...
//var_dump();
// echo registerToken('2625834','123456');

//授权注册模式 POST /{org_name}/{app_name}/users
function registerToken($nikename,$pwd)
{
	$formgettoken="https://a1.easemob.com/fanxin888/fanxin/users";
	$body=array(
		"username"=>$nikename,
		"password"=>$pwd,
	);
...
{
	$formgettoken="https://a1.easemob.com/fanxin888/fanxin/users/".$nikename."/password";
	$body=array(
		"newpassword"=>$newpwd,
	);
	$patoken=json_encode($body);
...
{
	$formgettoken="https://a1.easemob.com/fanxin888/fanxin/users/".$nikename;
	$body=array();
	$patoken=json_encode($body);
	$header = array(_get_token());
	$method = "DELETE";
...
function _get_token()
{
	$formgettoken="https://a1.easemob.com/fanxin888/fanxin/token";
	$body=array(
	"grant_type"=>"client_credentials",
	"client_id"=>"YXA6DsvlsLtXEeSUGSmUDPYgWA",
	"client_secret"=>"YXA6F4jwd3AMIoo6MMeOtYEyi5qH8B4"
	);
	$patoken=json_encode($body);
